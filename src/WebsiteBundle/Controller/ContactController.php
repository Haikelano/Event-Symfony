...
class ContactController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $contacts = $em->getRepository('WebsiteBundle:Contact')->findAll();
    ...
    {
        $contact = new Contact();
        $form = $this->createForm('WebsiteBundle\Form\ContactType', $contact);
    ...
    {
        $deleteForm = $this->createDeleteForm($contact);
        $editForm = $this->createForm('WebsiteBundle\Form\ContactType', $contact);
