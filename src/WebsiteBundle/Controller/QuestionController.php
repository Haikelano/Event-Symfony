...
use WebsiteBundle\Entity\Question;
use WebsiteBundle\Form\QuestionType;
...
class QuestionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $questions = $em->getRepository('WebsiteBundle:Question')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('WebsiteBundle\Form\QuestionType', $question);
    ...
    {
        $deleteForm = $this->createDeleteForm($question);
        $editForm = $this->createForm('WebsiteBundle\Form\QuestionType', $question);
