...
use WebsiteBundle\Form\TopicsType;
...
class TopicsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $topics = $em->getRepository('WebsiteBundle:Topics')->findAll();
    ...
    {
        $topic = new Topics();
        $form = $this->createForm('WebsiteBundle\Form\TopicsType', $topic);
    ...
    {
        $deleteForm = $this->createDeleteForm($topic);
        $editForm = $this->createForm('WebsiteBundle\Form\TopicsType', $topic);
