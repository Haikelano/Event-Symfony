...
class Contact
{
     ...
     * @var string
     *
     * @ORM\Column(name="companyAdress", type="string", length=100, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="companyPhone", type="string", length=45, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="companyMail", type="string", length=45, nullable=true)
     */
    private $companymail;
